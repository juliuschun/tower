...
import os from 'os';
import {
  authMiddleware, adminMiddleware, getUserAllowedPath,
...
import {
  canAccessSession, canDeleteSession, canAccessTask, canCreateInProject, isPathAccessible,
...
// ───── Mount auth routes (includes both public and per-route-authed endpoints) ─────
...
// ───── Mount admin routes (models, accounts, system-prompts, users, groups, fleet) ─────
...
// ───── Mount room & notification routes ─────
...
// ───── Mount automation routes (schedules, automations, proactive) ─────
